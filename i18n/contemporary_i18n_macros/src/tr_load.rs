...
pub fn tr_load(_body: TokenStream) -> TokenStream {
    ...
    quote! {
        {
            use contemporary_i18n::{I18nEntry, I18nSource, I18nStringEntry, I18nPluralStringEntry, Locale};
            use std::iter::once;
            ...
            impl I18nSource for AutogeneratedSource {
                fn lookup(&self, locale: &Locale, id: &str) -> Option<I18nEntry> {
                    for language in locale.messages_languages().into_iter().chain(once(#default_language.to_string())) {
